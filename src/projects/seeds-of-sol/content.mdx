...
import weaponSystem1 from "./weapon-system-1.gif";
import weaponSystem2 from "./weapon-system-2.gif";
...
<Figure className="w-100">
  <Figure.Image
    alt="Shooting two pistols while stationary"
    src={weaponSystem1}
    className="w-50 p-2"
  />
  <Figure.Image
    alt="Shooting two pistols while moving"
    src={weaponSystem2}
    className="w-50 p-2"
  />
  <Figure.Caption className="text-center">Shooting two pistols.</Figure.Caption>
</Figure>
