...
<Figure src={spitters} caption="Spitters" className="w-50 p-2" />
<Figure src={guardian} caption="Guardian" className="w-50 p-2" />
...
<Figure src={positioning1} caption="Enemies surrounding the player" className="w-50 p-2" />
<Figure src={positioning2} caption="Stress testing the positioning system" className="w-50 p-2 float-right" />
